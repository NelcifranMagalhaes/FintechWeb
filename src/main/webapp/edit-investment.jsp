            ...
            <div class="card-body">
                <form action="investments?action=update" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="description" id="id-description" required class="form-control" value="${investment.description}">
                    </div>
                    <div class="form-group">
                        <label for="id-value">Valor</label>
                        <input type="number" name="value" id="id-value" step="any" required class="form-control" value="${investment.value}">
                    </div>
